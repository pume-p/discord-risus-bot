...
client.once('ready', () => {
    ...
    console.log(client.guilds.cache.get('716807791574253599').channels.cache.get('716815120663183390').permissionOverwrites);
    console.log(client.guilds.cache.get('579966180681580544').channels.cache.get('789148404924153856').permissionOverwrites);
});
